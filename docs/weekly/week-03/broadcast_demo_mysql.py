...
功能：
1. 只读连接本地 MySQL 数据库 rcbi；
2. 从 mb_data_auto 读取实时快照，从 mb_data_his_auto 读取历史环数据；
3. 生成“上一环总结”“下一环预报”“安全警示”三类播报；
4. 每类播报分别导出 Markdown 和 JSON 文件。
"""
...
def build_previous_ring_output(context: Dict[str, Any], summary: Dict[str, Any], indicators: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return make_output_payload("上一环总结", context, summary, indicators, brief, detail)
...
def build_next_ring_output(context: Dict[str, Any], summary: Dict[str, Any], indicators: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return make_output_payload("下一环预报", context, summary, indicators, brief, detail)
...
def build_safety_warning_output(context: Dict[str, Any], summary: Dict[str, Any], indicators: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return make_output_payload("安全警示", context, summary, indicators, brief, detail)
